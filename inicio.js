...
app.controller('AppCtrl', ['$scope', '$mdBottomSheet','$mdSidenav', '$mdDialog', function($scope, $mdBottomSheet, $mdSidenav, $mdDialog){
  ...
  $scope.activity = [
      {
        what: 'Quien va al hackaton de escuela dev rock?',
        who: 'Jona',
        when: '15:22PM',
        notes: " Traigan facturas"
      },
      {
        what: 'Llego despues, es sabadomuy temprano, el viernes se rockea',
        who: 'to Jona',
        when: '3:08PM',
        notes: "Tambien llevo cafe, agua y buscapina"
      },
      {
        what: 'Aguante Boca',
        who: 'Mati',
        when: '3:08PM',
        notes: "Porque la vuelta vamo a dar"
      },
      {
        what: 'Riquelme > Messi',
        who: 'Antimessi',
        when: '3:08PM',
        notes: "Se acuerdan en 1912 cuando la pelota pego en el travesaño, bueno Riquelme se cansa de hacer eso, a Messi le falta un mundial"
      },
      {
        what: 'Eso se va a descontrolaaar, aiuda',
        who: 'El pocho',
        when: '3:08PM',
        notes: "Estoy bien"
      },
  ...
  $scope.showAdd = function(ev) {
    ...
    .then(function(answer) {
      $scope.alert = 'Tu respuesta fue la siguiente "' + answer + '".';
    }, function() {
      $scope.alert = 'Cancelaste el dialog.';
    });
  };
}]);
